<?php 
  // Contadores para ocultar o nome do avaliador com numeração
  // Exemplo: Gesil Sampaio Amarante Segundo irá aparecer como Avaliador Interno 1
  $avaliador_interno_count = 1;
  $avaliador_externo_count = 1;
?>
  ...
  <div class="portlet-body">
    ...
    <div id="avaliacoes_internas">
      ...
      <div class="portlet z-depth-1">
        ...
        <div class="portlet-title">
          ...
          Avaliador Interno <?= $avaliador_interno_count++ ?>
        </div>
        <!--END title-->
    ...
    <div id="avaliacoes_externas">
      ...
      <div class="portlet z-depth-1">
        ...
        <div class="portlet-title">
          <i class="material-icons">person</i>
          Avaliador Externo <?= $avaliador_externo_count++ ?>
        </div>
        <!--END title-->
        ...
        <div class="portlet-body">
          ...
          <p><?= $avaliacao_externa['observacao'] ? $avaliacao_externa['observacao'] : 'Nenhuma' ?></p>
